import { $, NoSerialize, component$, noSerialize, useStore, useVisibleTask$ } from "@builder.io/qwik";
...
export default component$(() => {
    ...
    useVisibleTask$(() => {
        ...
        timeline
            ...
            .fromTo(".button", { opacity: 0, scale: 0, rotation: 720 }, { opacity: 1, scale: 1, rotation: 0, ease: "elastic" })
    });
    ...
    return (
        <div class="overflow-hidden m-0 h-screen flex flex-col">
            ...
            <div class="content flex flex-grow justify-between">
                ...
                <button type="button" class="button align-middle" onClick$={buttonOnClick}>
                    Reverse
                </button>
